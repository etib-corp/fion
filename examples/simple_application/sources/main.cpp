...
public:
    std::unique_ptr<fion::Response> handle(std::unique_ptr<fion::Request> request) override {
        auto response = std::make_unique<fion::Response>();
        response->setStatusCode(fion::StatusCode::OK);
