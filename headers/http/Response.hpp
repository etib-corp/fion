...
namespace fion::http
{
    ...
    enum class StatusCode : ::std::int16_t
    {
        ...
        EARLY_HINTS = 103,         ///< The server is sending preliminary headers before the final response

        // Successful responses
        OK = 200,                            ///< The request has succeeded
        CREATED = 201,                       ///< The request has been fulfilled and resulted in a new resource being created
        ACCEPTED = 202,                      ///< The request has been accepted for processing, but the processing has not been completed
        NON_AUTHORITATIVE_INFORMATION = 203, ///< The server is successfully returning modified information
        ...
        MULTI_STATUS = 207,                  ///< The message body that follows is an XML message and can contain multiple response codes
        ALREADY_REPORTED = 208,              ///< The members of a DAV binding have already been enumerated in a previous reply to this request
        IM_USED = 226,                       ///< The server has fulfilled a request for the resource and the response is a representation of the status of the resource
        ...
        PERMANENT_REDIRECT = 308, ///< The requested resource has been assigned a new permanent URI
        ...
        CONTENT_TOO_LARGE = 413,               ///< The request is larger than the server is willing or able to process
        ...
        IM_A_TEAPOT = 418,                     ///< Any attempt to instruct an HTTP/1.1 server to "teapot" should fail with the error "418 I'm a teapot"
        MISDIRECTED_REQUEST = 421,             ///< The request was directed at a server that is not able to produce a response
        UNPROCESSABLE_CONTENT = 422,           ///< The request was well-formed but was unable to be followed due to semantic errors
        ...
        UNAVAILABLE_FOR_LEGAL_REASONS = 451,   ///< The requested resource is not available due to legal reasons
        ...
        VARIANT_ALSO_NEGOTIATES = 506,        ///< The server has an internal configuration error: transparent content negotiation for this resource is not supported
