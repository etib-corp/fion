...
const std::string fion::http::statusCodeToString(const fion::http::StatusCode statusCode)
{
    switch (statusCode)
    {
...
const std::string fion::http::Response::toRawResponse(void) const
{
    ...
    // Start line
    rawResponse << fion::http::VersionToString(_version) << " " << static_cast<unsigned short>(_statusCode) << " " << fion::http::statusCodeToString(_statusCode) << "\r\n";
