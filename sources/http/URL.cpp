...
namespace fion::http
{
        ...
        : scheme(""), domainName(""), port(0), pathToResource("/"), anchor("")
    {
        ...
        else
        {
            ...
            else
            {
                ...
                size_t portPos = hostPort.rfind(':'); // Use rfind to handle IPv6-like patterns
    ...
    std::string URL::getDomainName(void) const
    {
        return domainName;
    }

    std::uint16_t URL::getPort(void) const
    {
        return port;
    }

    std::string URL::getPathToResource(void) const
    {
    ...
    std::string URL::getAnchor(void) const
    {
        return anchor;
    }
    ...
    std::string URL::toString(void) const
    {
        ...
        if (!domainName.empty())
        {
            ...
            bool isDefaultPort = (scheme == "http" && port == 80) ||
